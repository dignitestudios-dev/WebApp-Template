const TermsCondition = () => {
  return (
    <div>
      <div className=" px-20 py-20 body">
        <div style={{ textAlign: "left" }}>
          ...
          >
            ...
            <bdt className="question">
              <strong>
                <h1 className="text-4xl mb-2" >TERMS AND CONDITIONS</h1>
              </strong>
            </bdt>
          ...
          >
            ...
            >
              ...
              <bdt
                ...
                data-type="question"
              >
                Brisbon Notary &amp; Consulting Services LLC
              </bdt>
              <bdt className="block-component" /> (
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <bdt className="question">North Carolina</bdt>,{" "}
            ...
            at <bdt className="question">7749 JACKSON POND DR </bdt>
            <bdt className="block-component" />,{" "}
            <bdt className="question">CHARLOTTE </bdt>
                ...
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <bdt className="block-component" />
                      <bdt className="block-component" />,{" "}
                      <bdt className="question">NC</bdt>
                      <bdt className="statement-end-if-in-editor" />
                      <bdt className="block-component" />
                      <bdt className="block-component" />{" "}
                      <bdt className="question">28273 </bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </span>
                  </span>
                </span>
        ...
        <div style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <bdt className="question">
                  <a
                    href="https://www.brisbonnotaryandconsulting.com"
                    target="_blank"
                    data-custom-class="link"
                  >
                    https://www.brisbonnotaryandconsulting.com
                  </a>
                </bdt>
              </span>{" "}
              ...
              <bdt className="question">
                Brisbon Notary &amp; Consulting Services
              </bdt>{" "}
          ...
          >
            ...
            >
              ...
              phone at <bdt className="question">7062311887</bdt>, email at{" "}
              <bdt className="question">
                abrisbon@brisbonnotaryandconsulting.com
              </bdt>
              <bdt className="block-component" />,
              <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
              <bdt className="question">7749 JACKSON POND DR </bdt>
              <bdt className="block-component" />,{" "}
              <bdt className="question">CHARLOTTE </bdt>
              <bdt className="block-component" />
              <bdt className="block-component" />,{" "}
            ...
            <a data-custom-class="link" href="#returnyes">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  RETURN
                  <bdt className="statement-end-if-in-editor" /> POLICY
                </span>
              </span>
            </a>
            <span style={{ fontSize: 15 }}>
          ...
          <ul>
            ...
            >
              <span style={{ fontSize: 15 }}>
                ...
                <bdt className="block-component" /> are original to you or that
        ...
        <div style={{ textAlign: "left" }}>
          ...
          >
            ...
            <strong>
              <span
                style={{ lineHeight: "1.5", fontFamily: "Arial", fontSize: 19 }}
              >
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 15 }}>
                ...
                <bdt className="block-component" />
                colors
                <bdt className="statement-end-if-in-editor" /> and details of
                the products. <bdt className="statement-end-if-in-editor" />
                All products are subject to availability
                <bdt className="block-component" />, and we cannot guarantee
                that items will be in stock
                <bdt className="statement-end-if-in-editor" />. We reserve the
        ...
        >
          ...
          <span style={{ fontSize: 15 }}>
            ...
            judgment
            <bdt className="statement-end-if-in-editor" /> on the award entered
            by the arbitrator.
          </span>
        </div>
        <div
        ...
        >
          <span
            style={{ fontSize: 19, lineHeight: "1.5", color: "rgb(0, 0, 0)" }}
          >
            <strong>
              <h2>21. DISCLAIMER</h2>
            </strong>
        ...
        >
          ...
          >
            ...
            >
              ...
              Terms; (<span style={{ fontSize: "14.6667px" }}>4</span>) your
        ...
        >
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <bdt className="question">
                <strong>Brisbon Notary &amp; Consulting Services LLC</strong>
              </bdt>
              <strong>
                <bdt className="block-component" />
              </strong>
            ...
            <strong>
              <strong>
                ...
                >
                  <strong>
                    <bdt className="block-component" />
                    Phone: <bdt className="question">7062311887</bdt>
                    <bdt className="statement-end-if-in-editor" />
                  </strong>
                </span>
              </strong>
